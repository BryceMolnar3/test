...
def send_to_mongodb(document_data, image_path=None, mongo_uri="mongodb://127.0.0.1:27017", db_name="document_db", collection_name="documents"):
    """
    ...
    if image_path:
        with open(image_path, "rb") as img_file:
            file_id = fs.put(img_file, filename=image_path)
            document_data["image_file_id"] = file_id
...
if __name__ == "__main__":
    ...
    try:
        ...
        inserted_id = send_to_mongodb(document_data, image_path)
